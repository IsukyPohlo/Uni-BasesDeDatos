	...
	<div class="col-12 box">
		...
		<div class="col-12 box">
			<div class = "content margup curvy">
				...
				//Consulta de los proyectos disponibles
					if ($Colaboradores->num_rows > 0){
						//Existen proyectos donde se es el LIDER
							...
							?> 
							<li onclick ="scargarAndGetColabAndProyectName('contenido','ul_proycolab.php','<?php echo $row1[UserName]; ?>','<?php echo $Proyecto; ?>');"><?php echo $row1[UserName]; ?> </li>
							<?php	 				
							}	
						}
						else{
				...
				?>
					<li class="high" onclick ="scargarAndGetProyectName('contenido','ul_invitar.php','<?php echo $Proyecto; ?>');">
					Invitar
					</li>
				</ul>
			</div>
		</div>
<!-- INICIO DE LISTADO DE TAREAS -->
	...
	<!-- ENCABEZADO DE TAREAS -->
				...
				<ul>
					...
					<li class="high" onclick ="scargarAndGetProyectName('contenido','ul_proycreart.php','<?php echo $Proyecto; ?>');">
					Crear Tarea
					</li>
		...
		<div class="col-12 box margup">
			...
			<div id="usuario" class="col-6 menu">
				<div class = "aside margup mid">
					<ul> 
						<li class="mid" onclick ="scargarAndGetProyectName('contenido','ul_proyel.php','<?php echo $Proyecto; ?>');">
							Eliminar Proyecto
						</li> 
					</ul>
				</div>
